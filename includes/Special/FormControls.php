...
trait FormControls {
	...
	/**
	 * Task <select> for the job shown in the job dropdown: a general-bucket
	 * option (value '' = job-level, labeled with a dash) followed by that job's
	 * tasks, with $selectedTaskId pre-selected.
	 */
